...
public class PmsOssController {
    ...
    String accessId = "LTAIVCSVQsSZ8mjm";      // 请填写您的AccessKeyId。
    String accessKey = "U7gMpZkPYwFbTrxtMBg9FWv8aILBgL"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "guli-jiaoyu";                    // 请填写您的 bucketname 。
